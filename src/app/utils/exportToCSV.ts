...
export const sampleData: Transaction[] = [
  {type: TransactionType.Expense, amount: 100, category: "food", date: new Date(), comment: "test"},
  {type: TransactionType.Expense, amount: 100, category: "education", date: new Date(), comment: "test2"},
  {type: TransactionType.Expense, amount: 100, category: "other", date: new Date(), comment: "test3"},
];
